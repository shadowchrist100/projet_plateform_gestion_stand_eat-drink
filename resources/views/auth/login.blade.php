    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
      ...
      <div>
        ...
        <input type="email" name="email" id="email" placeholder="votre@email.com"
               class="input w-full bg-white border border-black @error('email') input-error @enderror">
        @error('email')
      ...
      <div>
        ...
        <div class="relative">
          <input type="password" name="password" id="password" placeholder="Votre mot de passe"
                 class="input w-full pr-10 bg-white border border-black @error('password') input-error @enderror">
